...
const MainContact = () => {
  ...
  <section className="relative h-[350px] bg-[url('./office.png')] bg-cover bg-center">
    ...
    <div className="max-w-6xl mx-auto px-4 py-16">
      ...
      <p className="text-center text-gray-600 mb-12">Any questions or remarks? Just write us a message!</p>

      <form onSubmit={handleSubmit} className="max-w-2xl mx-auto space-y-6 mb-20 p-10 shadow-grey shadow-2xl">
        ...
        <div>
          <label htmlFor="companyName" className="block text-sm font-medium text-gray-700 mb-1">Your Company's Name</label>
          <input
            type="text"
            id="companyName"
            name="companyName"
        ...
        <div>
          <label htmlFor="website" className="block text-sm font-medium text-gray-700 mb-1">Company's Website</label>
          <input
            type="url"
            id="website"
            name="website"
      ...
      <div className="grid md:grid-cols-3 gap-8 bg-gray-100 p-8 rounded-lg p-10 shadow-grey shadow-2xl">
        ...
        <div className="text-center">
          ...
          <p className="text-gray-600">The Courtyard, Al Quoz 1, Colorado, USA</p>
        </div>
      </div>
    </div>
    </>
